...
public interface IProviderWebPort {
    ...
    @Action(input = "http://cs548.stevens.edu/clinic/service/web/soap/provider/IProviderWebPort/addTreatmentForPatientRequest", output = "http://cs548.stevens.edu/clinic/service/web/soap/provider/IProviderWebPort/addTreatmentForPatientResponse", fault = {
        @FaultAction(className = PatientNotFoundExn_Exception.class, value = "http://cs548.stevens.edu/clinic/service/web/soap/provider/IProviderWebPort/addTreatmentForPatient/Fault/PatientNotFoundExn"),
    ...
    public long addTreatmentForPatient(
        ...
        throws PatientNotFoundExn_Exception, ProviderNotFoundExn_Exception, ProviderServiceExn_Exception
    ;
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "siteInfo", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap/provider", className = "edu.stevens.cs548.clinic.service.web.soap.provider.SiteInfo")
    @ResponseWrapper(localName = "siteInfoResponse", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap/provider", className = "edu.stevens.cs548.clinic.service.web.soap.provider.SiteInfoResponse")
